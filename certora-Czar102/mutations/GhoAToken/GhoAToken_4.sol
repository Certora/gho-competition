...
contract GhoAToken is VersionedInitializable, ScaledBalanceTokenBase, EIP712Base, IGhoAToken {
  ...
  function handleRepayment(
    ...
    // mutation: '<=' => '<'
    // following this mutation, if amount == balanceFromInterest, the call to IGhoToken(_underlyingAsset)::burn should revert
    // since the amount being burned is 0, resulting in the denial of the repayment
