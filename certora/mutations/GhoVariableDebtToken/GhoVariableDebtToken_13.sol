  ...
  function updateDiscountDistribution(
    ...
    if (senderPreviousScaledBalance > 0) {
      ...
      _refreshDiscountPercent(
        ...
        //mutation: 'senderDiscountTokenBalance - amount' => 'senderDiscountTokenBalance'
        // doesn't decrement discount token balance, user can reuse until no debt is left
    ...
    if (recipientPreviousScaledBalance > 0) {
      ...
      _refreshDiscountPercent(
        ...
        //mutation: 'recipientDiscountTokenBalance + amount' => 'recipientDiscountTokenBalance'
