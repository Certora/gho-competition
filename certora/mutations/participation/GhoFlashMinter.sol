...
contract GhoFlashMinter is IGhoFlashMinter {
  ...
  modifier onlyPoolAdmin() {
    ...
    /// DeleteExpressionMutation(`require(ACL_MANAGER.isPoolAdmin(msg.sender), 'CALLER_NOT_POOL_ADMIN')` |==> ``) of: `require(ACL_MANAGER.isPoolAdmin(msg.sender), 'CALLER_NOT_POOL_ADMIN');`
    _;
  }
