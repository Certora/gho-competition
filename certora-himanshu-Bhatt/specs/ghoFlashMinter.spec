...
//after calling flashLoan() the gho balance of currentContract must increase;
// rule feeReturn(){
//     address receiver;
//     address token;
//     uint256 amount;
...
rule zeroBalanceAfterdistributeFeesToTreasury(){
    env e;
    distributeFeesToTreasury(e);
    assert gho.balanceOf(currentContract)==0;
}